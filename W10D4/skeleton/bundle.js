...
var GiphysSearch = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(GiphysSearch, [{
    ...
    value: function render() {
      ...
      }, "Search Giphy")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_giphys_index__WEBPACK_IMPORTED_MODULE_1__["default"], {
        giphys: giphys
      }));
    }
  }]);
...
var fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  return $.ajax({
    method: "GET",
    URL: "http://api.giphy.com/v1/gifs/search?q=".concat(searchTerm, "&api_key=4udiSNjtmV4cW5yipdqlBJLAMeRKvtqn")
  });
};
